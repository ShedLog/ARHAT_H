...
#define pinLed	13	// PB 1 ** pin13 + PWM13 + T0outA + T1outC + PC_INT_7 !!! INTERNAL LED! Can't be input pin!!! **

#define pin0	0	// PD 0 ** pin30 + USART0_RX + PC_INT_16 **
#define pin1	1	// PD 1 ** pin31 + USART0_TX + PC_INT_17 **
#define pin2	2	// PD 2 ** pin32 + INT_0 **
#define pin3	3	// PD 3 ** pin1 + PWM1 + INT_1 **
#define pin4	4	// PD 4 ** pin2 + T0 **
#define pin5	5	// PD 5 ** pin9 + PWM2 + T0**
#define pin6	6	// PD 6 ** pin10 + PWM3 + AIN0 **
#define pin7	7	// PD 7 ** pin11 + AIN1 **
#define pin8	8	// PB 0 ** pin12 + ICP **
#define pin9	9	// PB 1 ** pin13 + PWM4 + OC1 **
#define pin10	10	// PB 2 ** pin14 + PWM5 + SS **
#define pin11	11	// PB 3 ** pin15 + PWM6 + MOSI **
#define pin12	12	// PB 4 ** pin16 + MISO **
#define pin13	13	// PB 5 ** pin17 + SCK + !!! INTERNAL LED! Can't be input pin!!! **


#define pin54	54	// PC 0 ** Analog0 **
#define pin55	55	// PC 1 ** Analog1 **
#define pin56	56	// PC 2 ** Analog2 **
#define pin57	57	// PC 3 ** Analog3 **
#define pin58	58	// PC 4 ** Analog4 **
#define pin59	59	// PC 5 ** Analog5 **
#define pin60	60	// ADC 6 ** Analog6 + 10BIT ADC **
#define pin61	61	// ADC 7 ** Analog7 + 10BIT ADC **

...
согласно предыдущему тексту "таймер 8/16bit", означает: номер 8бит-таймера 1 или 2 и 16бит-таймера 3,4 или 5.
  Соответственно, такие же двойные скобки перечисляют допустимый набор парамтеров для второго (и т.д.) параметра, если он есть.
...
Хорошо и популярно описан во многих местах под разными названиями.
...
команд для возвращаемых значений текущей командой true|false.
